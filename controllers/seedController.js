...
const seedUsers = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: 'User seeding data inserted successfully', users });
...
const seedProducts = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: 'Product seeding data inserted successfully', products });
